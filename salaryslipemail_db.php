<?php   include_once 'inc/connection.php';
        ...
        for($j=0;$j<count($_POST['employee_id']);$j++){
                ...
                $grossdeduction = 0;
                $netsalary = 0;
                $filename = $monthyearsel2."-salaryslip-".$rwselecemployeedata['e_id'].".pdf";
                $filename_path="UploadImages/salryslip/".$filename;
                for($i=1;$i<=31;$i++){
                    if($i==1){
                        $day = "01";
                    }else if($i==2){
          ...
          $html = '<html>
                        ...
                        <body style="margin:0">
                            ...
                            <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                <tr>
                                    ...
                                    <td style="border: 1px solid;font-weight: bold;background: #ccc;text-align: center;padding: 5px 0;width: 20%;border-left: 0;font-size:11px;">BALANACE</td>
                                </tr>
                                <tr>
                                    <td>
                                        <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    $to = $rwselecemployeedata['e_email'];
                    $from = 'humabizconllp@gmail.com'; 
                    $fromName = 'Humabizconllp';
                    $subject = 'Salary Slip';
                    $file = $filename_path;
            
                    $htmlContent = '<h3>Salary Slip Sent From '.strtoupper($_SESSION['company_name']).'</h3>'; 
        ...
        $_SESSION["msg"] = "<div class='alert alert-success'>Salary Sleep Of ".$_POST['month']."-".$_POST['year']." Sent Email Successfully.</div>";
        header("location:salaryslip.php?e_depart_id=".$_POST['depart_id']."&e_sub_depart_id=".$_POST['sub_depart_id']."&e_month_id=".$_POST['month']."&e_year_id=".$_POST['year']);
        exit();
?>