          ...
          <div class="container-fluid page-body-wrapper">
              <div class="main-panel">
                  <div class="content-wrapper">
                      ...
                      <form id="change_profile" name="change_profile" action="monthlyreport_db.php" method="post" autocomplete="off" enctype="multipart/form-data">
                          <div class="row">
...
<script>
    ...
    jQuery(document).ready(function(){
        ...
        jQuery(document).on('click','#add_bottom',function(){
            $.ajax({
              type:'post',
              url:base_url+'monthlyreport_db.php',
