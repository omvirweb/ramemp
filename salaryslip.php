          ...
          <div class="container-fluid page-body-wrapper">
              <div class="main-panel">
                  <div class="content-wrapper">
                        	...
                        	<form action="salaryslip.php" method="post">
		                          <div class="row">
		                            <div class="col-md-3 col-xs-12">
		                              <h3 class="font-weight-bold">Salary Slip</h3>
		                            </div>
                      ...
                      <form id="change_profile" name="change_profile" action="salaryslip_db.php" method="post" autocomplete="off" enctype="multipart/form-data">
                          <div class="row">
                          ...
                          <?php if($nmselectpackunit > 0){ ?>
                              ...
                              <div class="generate_btn" style="margin: 0 auto;text-align: center;">
                                <button type="button" class="btn btn-primary mr-2" id="add_bottom" style="margin: 0 auto !important;text-align: center;display: inline-block;">Preview</button>
                                <button type="submit" class="btn btn-primary mr-2" id="add_bottom_email" style="margin: 0 auto !important;text-align: center;display: inline-block;">Sent Email</button>
                              </div>
                          <?php } ?>
                        </form>
                  </div>
...
<script>
    ...
    jQuery(document).ready(function(){
        ...
        $('.individually_delete').on('click',function(){
        ...
        jQuery(document).on('click','#add_bottom',function(){
            $.ajax({
              type:'post',
              url:base_url+'salaryslip_db.php',
        ...
        jQuery(document).on('click','#add_bottom_email',function(){
            jQuery("#change_profile").attr("action","salaryslipemail_db.php");
        });
