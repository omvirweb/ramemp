                  ...
                  <div class="content-wrapper">
                      <div class="row">
                        <div class="col-md-12 mb-3">
                          <form action="wages.php" method="post">
                              <div class="row">
                                <div class="col-md-3 col-xs-12">
                                  <h3 class="font-weight-bold">Wages</h3>
                                </div>
                      ...
                      <form id="change_profile" name="change_profile" action="wages_db.php" method="post" autocomplete="off" enctype="multipart/form-data">
                          <div class="row">
