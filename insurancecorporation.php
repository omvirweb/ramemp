...
<head>
<?php
        $page_name = "Insurance Corporation";
        ...
        if(!isset($_SESSION['ist_admin']) && $_SESSION['ist_admin'] == ""){
            ...
            exit();
        }else if($ur_insuration_corporation == '0'){
                  ...
                  <div class="content-wrapper">
                      <div class="row">
                        <div class="col-md-12 mb-3">
                        	<form action="insurancecorporation.php" method="post">
		                          <div class="row">
		                            <div class="col-md-3 col-xs-12">
		                              <h3 class="font-weight-bold">Insurance Corporation</h3>
		                            </div>
                      ...
                      <form id="change_profile" name="change_profile" action="insurancecorporation_db.php" method="post" autocomplete="off" enctype="multipart/form-data">
                          <div class="row">
...
<script>
    ...
    jQuery(document).ready(function(){
        ...
        jQuery(document).on('click','#add_bottom',function(){
            $.ajax({
              type:'post',
              url:base_url+'insurancecorporation_db.php',
