...
<head>
<?php
        $page_name = "Download Salary Slip";
                  ...
                  <div class="content-wrapper">
                      <div class="row">
                        <div class="col-md-12 mb-3">
                        	<form action="downloadsalaryslip.php" method="post">
		                          <div class="row">
		                            <div class="col-md-3 col-xs-12">
		                              <h3 class="font-weight-bold">Download Salary Slip</h3>
		                            </div>
                      ...
                      <form id="change_profile" name="change_profile" action="downloadsalaryslip_db.php" method="post" autocomplete="off" enctype="multipart/form-data">
                          <div class="row">
                                      ...
                                      <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                  ...
                                                  ?>
                                                        <td><?php echo $checkattendence; ?></td>
                                                  <?php } ?>
                                                </tr>
                                        <?php    }
                                              }else{ ?>
                                                <tr>
                                                  <td class="text-danger text-center" colspan="33">No Employee Found.</td>
                                                </tr>
                                        <?php } ?>
                                      </tbody>
                                    </table>
                          ...
                          <?php if($nmselectpackunit > 0){ ?>
                              ...
                              <div class="generate_btn">
                                <button type="submit" class="btn btn-primary mr-2" id="add_bottom" style="margin: 0 auto !important;text-align: center;display: block;">Generate Excel</button>
                              </div>
                          <?php } ?>
                        </form>
                  </div>
