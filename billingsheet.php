                  ...
                  <div class="content-wrapper">
                      <div class="row">
                        <div class="col-md-12 mb-3">
                          <form action="billingsheet.php" method="post">
                              <div class="row">
                                <div class="col-md-3 col-xs-12">
                                  <h3 class="font-weight-bold">Billing Sheet</h3>
                                </div>
                      ...
                      <form id="change_profile" name="change_profile" action="billingsheet_db.php" method="post" autocomplete="off" enctype="multipart/form-data">
                          <div class="row">
...
<script>
    ...
    jQuery(document).ready(function(){
        ...
        jQuery(document).on('click','#add_bottom',function(){
            $.ajax({
              type:'post',
              url:base_url+'billingsheet_db.php',
